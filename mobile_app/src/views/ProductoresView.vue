  ...
  methods: {
    ...
    async loadProductores() {
      try {
        ...
        if (predios.length === 0) {
          // Si el catálogo local está vacío, cargar mock data de alta fidelidad basado en el screenshot del usuario
          const mockPredios = [
            {
              id: 'MOCK_PREDIO_1',
              nombre: 'El Refugio',
            ...
            },
            {
              ...
              productor: {
                id: 8,
                nombre: 'EDGAR ELISEO',
                apellido_paterno: 'CHEVARRIA',
                apellido_materno: 'SANCHEZ',
                curp: 'CHSE880404HNTLRR06',
                upp: '180104327002',
                telefono: ''
              }
            },
            ...
            },
            {
              ...
              productor: {
                ...
                curp: 'MERS901212MNTLRR11',
                upp: '123456780',
                telefono: '3116549870'
              }
            }
          ];
          await db.savePredios(mockPredios);
          predios = mockPredios;
        }
