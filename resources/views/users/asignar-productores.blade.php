...
<div class="row">
    <div class="col-lg-12">
        ...
        <form action="{{ route('usuarios.guardar-asignacion', $usuario) }}" method="POST">
            @csrf
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body p-0" style="max-height: 500px; overflow-y: auto;">
                            ...
                            <div class="d-flex justify-content-between align-items-center p-3 border-bottom">
                                <div>
                                    <div class="fw-bold">{{ $productor->nombre }} {{ $productor->apellido_paterno }} {{ $productor->apellido_materno }}</div>
                ...
                <div class="col-md-7 mb-4">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-primary rounded-pill">{{ $disponibles->total() }}</span>
                        </div>
                                ...
                                <div class="d-flex align-items-center p-3 border-bottom item-disponible" data-search="{{ strtolower($productor->nombre . ' ' . $productor->apellido_paterno . ' ' . $productor->apellido_materno . ' ' . $productor->curp . ' ' . $productor->upp) }}">
                                    <div class="form-check me-3">
                                        <input 
                                            ...
                                            {{ in_array($productor->id, $asignados->pluck('id')->toArray()) ? 'checked' : '' }}
                                        >
                                    </div>
